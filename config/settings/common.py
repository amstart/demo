# -*- coding: utf-8 -*-
"""
Django settings for demoslogic project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'demoslogic.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Jochen Krattenmacher""", 'jochen.krattenmacher@web.de'),
)
...
ACCOUNT_ADAPTER = 'demoslogic.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'demoslogic.users.adapters.SocialAccountAdapter'
